...
var grokOgIdentity = { "site": {
	"title": "Granary",
	"description": "Book cold rooms and dry yards around Nashik. Watch your harvest on a live map.",
	"type": "website",
	"card": "custom",
	"image": "/og.jpg"
} };
...
async function securityHeaders(_event, next) {
	...
	if (result instanceof Response) {
		...
		if (!headers.has("permissions-policy")) headers.set("permissions-policy", "camera=(), microphone=(), geolocation=(), payment=(), usb=(), magnetometer=()");
...
var _lazy_trX2Mz = defineLazyEventHandler(() => import("./_chunks/ssr-renderer.mjs"));
var findRoute = /* @__PURE__ */ (() => {
	const data = {
		route: "/**",
		handler: _lazy_trX2Mz
	};
	return ((_m, p) => {
		return {
			data,
